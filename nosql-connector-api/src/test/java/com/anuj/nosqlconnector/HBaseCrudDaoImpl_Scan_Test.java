...
public class HBaseCrudDaoImpl_Scan_Test {
    ...
    public void testSave(){
        ...
        try{
            ...
            final List<Result> result = hbaseFacade.scan(scanHBaseTableDTO);

            final List<HBTableRowMapping<? extends Serializable>> resp = hbaseDataIntegrationService.convertFromResultObjects(result, HBaseRowKeyType.STRING);
            final List<Table_1_Model> response = mapper.mapListFromTableRowMappings(resp, Table_1_Model.class.getCanonicalName());
